...
def calculate_distance(x1: float, y1: float, x2: float, y2: float) -> float:
    ...
    NOTE: distance is not square rooted
    :param x1:
    :param y1:
    :param x2:
    :param y2:
                ...
                if report.status.value == drone_status.DroneStatus.HALTED.value:
                    ...
                    for landing_pad in landing_pad_locations:
                        ...
                        if distance < min_distance:
                            ...
                            self.__closest_pad_location = location.Location(x2, y2)

                    closest_pad_x_relative = (
                        self.__closest_pad_location.location_x - report.position.location_x
                    )
                    closest_pad_y_relative = (
                        self.__closest_pad_location.location_y - report.position.location_y
                    )
