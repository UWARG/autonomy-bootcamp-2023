...
class DecisionWaypointLandingPads(base_decision.BaseDecision):
    ...
    def run(
        ...
        def calculate_l2_norm_squared(
            ...
            #avoid calculating the square root since we don't need it for the current purpse
        ...
        if self.arrived_at_waypoint == False:
            ...
            if report.status == drone_status.DroneStatus.MOVING:
                ...
                if validate_arrival_at_destination(report.position, self.nearest_landing_pad_result):
                    return halt_command
                else: 
                    return default_null_command
