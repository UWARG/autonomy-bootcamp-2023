...
class DecisionWaypointLandingPads(base_decision.BaseDecision):
    ...
    def _calculate_distance(self, pos1: location.Location, pos2: location.Location) -> float:
        ...
        """
        return ((pos1.location_x - pos2.location_x) ** 2 + 
                (pos1.location_y - pos2.location_y) ** 2) ** 0.5
    

    def _find_nearest_landing_pad(self, current_pos: location.Location, 
    ...
    def run(
        ...
        if distance_to_waypoint <= self.acceptance_radius and not self.selected_landing_pad:
            ...
            self.selected_landing_pad = self._find_nearest_landing_pad(report.position, landing_pad_locations)
