...
class DecisionWaypointLandingPads(base_decision.BaseDecision):
    ...
    def run(
        ...
        def validate_arrival_at_destination(flight_position: location.Location, destination_position: location.Location):
            ...
            print("flight_position.location_x,flight_position.location_y",flight_position.location_x,flight_position.location_y )
            print("destination_position.location_x, destination_position.location_y", destination_position.location_x, destination_position.location_y) 
        ...
        #Loop through the list of landing pad locations and find the nearest landing pad from the original location by finding the minimum L2 norm between the starting position and the landingpad_lcation
        def calculate_nearest_landing_pad(starting_position: location.Location, landingpad_locations: "list[location.Location]"):
        ...
        while True:
            ...
            if report.status == drone_status.DroneStatus.HALTED:
                ...
                if validate_arrival_at_destination(report.position,self.waypoint):
                    ...
                    set_relative_destination_command_result = (get_set_relative_distance_command(60, 60))
