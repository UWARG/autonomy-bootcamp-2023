...
class DecisionWaypointLandingPads(base_decision.BaseDecision):
        ...
        if status == halted:
            if not self.reached_at_waypoint:
                ...
                if abs(relative_x) < self.acceptance_radius and abs(relative_y) < self.acceptance_radius:
                    ...
                    self.the_closest_landing_pad = self.find_closest_landing_pad(report.position, landing_pad_locations)
    ...
    def find_closest_landing_pad(self, current_position: location.Location, landing_pads: "list[location.Location]"):
        closest_pad = None
