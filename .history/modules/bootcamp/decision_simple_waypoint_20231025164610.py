...
class DecisionSimpleWaypoint(base_decision.BaseDecision):
    ...
    def run(
        ...
        print("destination x", report.destination.location_x, "destination y", report.destination.location_y)
        ...
        if report.status == drone_status.DroneStatus.HALTED:
            if report.position == report.destination:
                ...
                set_relative_destination_command_result = (get_set_relative_distance_command(self.acceptance_radius))
