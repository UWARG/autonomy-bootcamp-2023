...
class DecisionSimpleWaypoint(base_decision.BaseDecision):
    ...
    def run(
        ...
        def get_set_relative_distance_command(
            ...
            print("11111111111111111x_distance, y_distance",x_distance,y_distance)
            ...
            print("sign_x_distance, sign_y_distance",sign_x_distance, sign_y_distance)
            print("relative_flight_boundary_y_abs",sign_x_distance, sign_y_distance)


            if (abs(x_distance) > abs(relative_flight_boundary_x_abs)):
                x_distance = relative_flight_boundary_y_abs * sign_y_distance
