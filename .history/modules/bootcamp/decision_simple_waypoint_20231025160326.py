    ...
    def run(
        ...
        if report.status == drone_status.DroneStatus.HALTED:
            if report.position == report.destination:
                ...
                set_relative_destination_command = commands.Command.create_set_relative_destination_command(report.destination.location_x-report.position.location_x, report.destination.location_y-report.position.location_x)
